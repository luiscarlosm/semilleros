...
Route::get('/academic_programs/new', 'AcademicProgramsController@newAcademicProgram');
Route::get('/academic_programs/{academicProgram}', 'AcademicProgramsController@show');
Route::post('/academic_programs/create', 'AcademicProgramsController@create');
Route::get('/research_centers', 'ResearchCentersController@listResearchCenters');
